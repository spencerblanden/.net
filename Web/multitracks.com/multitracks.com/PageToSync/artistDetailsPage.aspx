<%@ Page Language="C#" AutoEventWireup="true" CodeFile="artistDetailsPage.aspx.cs" Inherits="artistDetailsPage" %>
...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						 <asp:Image ID="hero" runat="server" class="details-banner--hero--img"/>
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								 <asp:Image ID="image" runat="server" class="details-banner--info--box--img"/>
						</a>
						<h1 class="details-banner--info--name">
							<asp:Label  ID="artistName" runat="server" />
						</h1>     
					</div>
				</div>
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--player-img media-player">
												...
												src="<%#Eval("albumImage") %>"g" alt="<%#Eval("albumName") %>">
											</div>
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">									
											...
											<asp:Repeater runat="server" ID="repeaterAlbums" >
											...
											<ItemTemplate>
												<div class="media-item">
													...
													<a class="media-item--title" href="#" tabindex="0">
													<%#Eval("title") %>
													</a>
			...
			<!--IMPORTANT#include virtual = "../includes/footer.aspx" -->
